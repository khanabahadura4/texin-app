...
function MainApp() {
  ...
  // Android hardware back button: close open modals/sub-views first, then go to Feed,
  // and only let the OS actually exit the app when we're already at Feed with nothing open.
  useEffect(() => {
    const listenerPromise = CapacitorApp.addListener('backButton', () => {
      ...
      if (activeTab === 'profile' && selectedProfileUserId) {
  ...
  }, [activeTab, selectedProfileUserId, isCreatePostOpen, isSignUpOpen]);
